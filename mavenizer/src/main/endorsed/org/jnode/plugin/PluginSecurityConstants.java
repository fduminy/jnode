...
public interface PluginSecurityConstants {
     ...
     */
    static final Permission START_PERM = null;
    /**
     * Permission required to stop a plugin
     */
    static final Permission STOP_PERM = null;

    /**
     * Permission required to load a plugin
     */
    static final Permission LOAD_PERM = null;
    /**
     * Permission required to unload a plugin
     */
    static final Permission UNLOAD_PERM = null;
}
