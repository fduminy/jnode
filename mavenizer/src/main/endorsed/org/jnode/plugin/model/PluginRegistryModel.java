 ...
 * @author epr
 */
public final class PluginRegistryModel implements
    PluginRegistry {

    /**
     * A map of all descriptors (id, descriptor)
     */
    private final Map<String, PluginDescriptor> descriptorMap;
    ...
    PluginRegistryModel(URL[] pluginFiles) throws PluginException {
        ...
        this.descriptorMap = new HashMap<String, PluginDescriptor>();
    ...
    protected synchronized void registerExtensionPoint(ExtensionPoint ep)
        throws PluginException {
        final Map<String, ExtensionPoint> epMap = this.extensionPoints;
